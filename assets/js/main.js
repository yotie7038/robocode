...
function toggleContent(button) {
  ...
  if (
    ...
    button.innerHTML = '<i class="fas fa-arrow-right"></i> READ LESS'; // Change button text to "Read Less"
  } else {
    hiddenContent.style.display = "none"; // Hide content
    button.innerHTML = '<i class="fas fa-arrow-right"></i> READ MORE'; // Change button text to "Read More"
  }
}
